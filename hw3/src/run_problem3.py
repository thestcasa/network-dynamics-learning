...
def main():
    ...
    print(
        f"[3] PA graph: n={N_PA}, target k={K_PA}, "
    ...
    summary = run_many(
        ...
        WEEKS,
        N_RUNS,
        base_seed=DEFAULT_SEED + 3000,
        vacc_schedule=VACC_PROBLEM3,
    )
    weeks = summary["weeks"]

    write_weekly_csv(
        RESULTS_DIR / "problem3_newly_infected_vaccinated.csv",
        weeks,
        {
    ...
    write_weekly_csv(
        RESULTS_DIR / "problem3_sirv_totals.csv",
        weeks,
        {
    ...
    print(
        f"[3] peak newly-infected at week {peak_week} "
