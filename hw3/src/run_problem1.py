...
from constants import (BETA, DEFAULT_SEED, FIGURES_DIR, K_KREGULAR, K_PA, N_INIT_INFECTED,
                       N_KREGULAR, N_PA, N_RUNS, RESULTS_DIR, RHO, WEEKS)
...
def run_kregular_epidemic():
    ...
    print(f"[1.1] k-regular graph: n={N_KREGULAR}, k={K_KREGULAR}, "
    ...
    write_weekly_csv(
        RESULTS_DIR / "problem1_kregular_newly_infected.csv", weeks,
        {"newly_infected_mean": summary["newly_infected_mean"],
         "newly_infected_std": summary["newly_infected_std"]},
    )
    write_weekly_csv(
        RESULTS_DIR / "problem1_kregular_sir_totals.csv", weeks,
        {"S_mean": summary["S_mean"], "I_mean": summary["I_mean"],
         "R_mean": summary["R_mean"], "S_std": summary["S_std"],
         "I_std": summary["I_std"], "R_std": summary["R_std"]},
    )

    plot_lines(
        weeks, {"newly infected": summary["newly_infected_mean"]},
    ...
    print(f"[1.1] peak newly-infected at week {peak_week} "
