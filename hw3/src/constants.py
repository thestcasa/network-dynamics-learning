...
# --- Disease-dynamics parameters (Problems 1.1, 2, 3) ---
...
# --- Vaccination schedule for Problem 3 (cumulative % by week 1..15) ---
VACC_PROBLEM3 = [0, 5, 15, 25, 35, 45, 55, 60, 60, 60, 60, 60, 60, 60, 60]

# --- Problem 4: H1N1 Sweden 2009 (population scaled down by 1e4) ---
